  ...
  return (
    <div className="animate-fade-in">
      ...
      <div style={{ textAlign: 'center', marginTop: 16, fontSize: 13, color: '#64748b' }}>
        {t('mcp.moreComingSoon', '(更多连接器即将上线)')}
      </div>
      ...
      >
        <Form form={form} layout="vertical" style={{ marginTop: 16 }}>
          ...
          <Form.Item name="type" label={t('mcp.typeLabel')} rules={[{ required: true }]} initialValue="database">
            <Select
              options={[
                { label: 'Database (PostgreSQL/MySQL)', value: 'database' },
