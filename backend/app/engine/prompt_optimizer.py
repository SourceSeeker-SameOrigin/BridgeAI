...
After your main response, include a structured analysis in the following format:
<analysis>
{"emotion": "<emotion>", "intent": "<intent>", "complexity": "<complexity>", "key_facts": ["<fact1>", "<fact2>"], "needs_tool": <true/false>, "suggested_tools": ["<tool_name>"]}
</analysis>
...
- key_facts: 从对话中提取的值得记住的关键信息列表
- needs_tool: 是否需要调用外部工具 (true/false)
- suggested_tools: 建议调用的工具名称列表（无需工具时为空数组）
"""
