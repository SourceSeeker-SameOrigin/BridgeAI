...
class Settings(BaseSettings):
    ...
    # Embedding API (optional - falls back to Ollama if not set)
    ...
    # WeChat Open Platform (微信开放平台 - 网站应用扫码登录)
    WECHAT_OPEN_APP_ID: str = ""
    WECHAT_OPEN_APP_SECRET: str = ""
    WECHAT_OPEN_REDIRECT_URI: str = ""  # e.g. https://yourdomain.com/api/v1/auth/wechat/callback
