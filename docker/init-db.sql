...
-- ============================================================
-- Note: IVFFlat indexes require existing data for optimal list count.
-- Using a small lists value suitable for development.
-- For production, rebuild indexes with lists = sqrt(row_count).
